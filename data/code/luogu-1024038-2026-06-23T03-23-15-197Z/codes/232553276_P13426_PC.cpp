...
//			if(i % prime1[j] == 0) break; //±£Ö¤Ã¿¸öºÏÊý±»Ëü×îÐ¡µÄÖÊÒòÊýÉ¸È¥
//		}
//	}
//}
//int gcd(int a, int b)
...
//	return ans % p;
//}
//int solve1(int l, int r){ //×î´óºÏ·¨½â
//	int ans = -1;
//	while(l <= r) {
//		int mid = l + r >> 1;
...
//	return ans;
//}
//int solve2(int l, int r) //×îÐ¡ºÏ·¨½â
//{
//	int ans = -1;
//	while(l <= r) {
//		int mid = l + r >> 1;
...
//        *this=num;
//    }
//    fantastic operator+(const fantastic &a)   //ÕâÀïÔÚÖØÔØ ¡°+¡± µÄÔËËã
//    {
//        fantastic c;
//        c.len=max(len,a.len)+1;                //ÕâÀï¾ÍÊÇÎÒÃÇÊìÏ¤µÄÊúÊ½Ä£ÄâÁË
...
//        return c;
//    }
//    fantastic operator * (const fantastic &x)           //È»ºóÔÙÀ´²¨ ¡°*¡± µÄÔËËã
//    {
//        fantastic c;
//        c.len=len+x.len;                 //ÓÖÊÇÎÒÃÇÊìÏ¤µÄÊúÊ½Ä£Äâ
//        for(int i=0;i<len;++i)
...
//    }
//};
//ostream& operator<<(ostream &out,const fantastic& x)   //ÖØÔØÒ»ÏÂÊä³ö
//{
//    for(int i=x.len-1;i>=0;--i)
//        cout<<x.s[i];
//    return out;
//}
//istream& operator>>(istream &in,fantastic &x)       //ÖØÔØÒ»ÏÂÊäÈë
//{
//    char num[9999];
//    in>>num;
//    x=num;
