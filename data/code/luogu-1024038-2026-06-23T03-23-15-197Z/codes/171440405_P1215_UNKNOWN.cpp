...
//#define int long long
//int gi() {
//	char z = getchar() ; int cn = 0, flus = 1 ;
//	while( z < '0' || z > '9' ) {  if( z == '-' ) flus = - flus ; z = getchar() ; }
//	while( z >= '0' && z <= '9' )  cn = cn * 10 + z - '0', z = getchar() ;
//	return cn * flus ;
//}
//const int P = 1e9 + 7 ;
//int T, n ;
...
//}
//Polya 定理
int a,b,c,ans[30],vis[30][30][30],pd;
